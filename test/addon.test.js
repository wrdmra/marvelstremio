...
test("manifest defines exactly the three requested catalogs", () => {
...
test("all catalog entries use matching types and IMDb IDs", () => {
...
test("MCU catalog follows chronological timeline order", () => {
  assert.deepEqual(
...
test("Stremio skip parameter is parsed from the request path", () => {
...
test("HTTP endpoints return the manifest, catalogs, and CORS headers", async () => {
